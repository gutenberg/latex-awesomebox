...
rule width, or your own horizontal rules at the top and the bottom of
your boxes, you can use our meta command:

\begin{center}
\verb!\awesomebox[rulecolor][hrule]{rulewidth}{icon}{iconcolor}{your text content}!
\end{center}
...
\begin{center}
\verb!\awesomebox[black][\abHline]{2pt}{\faBomb}{black}{Lorem ipsum…}!
\end{center}

\awesomebox[black][\abHline]{2pt}{\faBomb}{black}{Lorem ipsum dolor sit amet,
  consectetur adipiscing elit. Nam aliquet libero quis lectus elementum
  fermentum.
...
\begin{verbatim}
\begin{awesomeblock}[rulecolor][hrule]{rulewidth}{icon}{iconcolor}
  your text content
\end{awesomeblock}
\end{verbatim}
...
The version 0.5 of this package introduces a way to customize the rule
color, and allows you to specify whether and what kind of horizontal
rules you want at the top and the bottom of your boxes. Thus, the
