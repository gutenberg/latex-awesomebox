...
To create your own box, with your own colour, your own icon, your own
rule width, your own horizontal rules at the top and the bottom of
your boxes, or a title, you can use our meta command:

\begin{center}
\verb!\awesomebox[rulecolor][hrule][title]{rulewidth}{icon}{iconcolor}{your text content}!
\end{center}
...
\begin{center}
\verb!\awesomebox[white][\abCline]{0pt}{\faGrinBeam[regular]}{black}{Lorem ipsum…}!
\end{center}

\awesomebox[white][\abCline]{0pt}{\faGrinBeam[regular]}{black}{Lorem ipsum dolor sit amet,
  consectetur adipiscing elit. Nam aliquet libero quis lectus elementum
  fermentum.
...
\begin{center}
\verb!\awesomebox[white][\abHline][\textbf{Watch out}]{0pt}{\faBomb}{black}{Lorem ipsum…}!
\end{center}

\awesomebox[white][\abHline][\textbf{Watch out}]{0pt}{\faBomb}{black}{Lorem ipsum dolor sit amet,
  consectetur adipiscing elit. Nam aliquet libero quis lectus elementum
  fermentum.
...
\begin{verbatim}
\begin{awesomeblock}[rulecolor][hrule][title]{rulewidth}{icon}{iconcolor}
  your text content
\end{awesomeblock}
\end{verbatim}
...
Version 0.5 of this package introduces options to customize the
rule color, to specify whether and what kind of horizontal rules you
want at the top and the bottom of your boxes, and to add a title.
Thus, the commands and environments arguments have been reorganized
to be in a more logical order.
